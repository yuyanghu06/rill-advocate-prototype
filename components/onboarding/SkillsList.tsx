...
export default function SkillsList({ userId, is_recruiter = false }: { userId: string; is_recruiter?: boolean }) {
      ...
      >
        <div className="flex items-center gap-2">
          <p className="text-xs font-semibold text-slate-400 uppercase tracking-wide">
            {is_recruiter ? "Required Skills" : "Skills"}
          </p>
          {count > 0 && (
            ...
            <div className="space-y-1.5">
              {count === 0 ? (
                <p className="text-xs text-slate-400 italic">
                  {is_recruiter ? "No required skills yet — share a job description to get started." : "No skills identified yet — share your resume or GitHub to get started."}
                </p>
              ) : (
